...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  {
    key: 'AUTO_REPAIR_MIN_SCORE',
    label: 'Auto Repair Min Score',
    description: '项目生成完成后，如果内容质量分低于该分数，会自动进入补全巡检。',
    category: 'queue',
    input: 'number',
    envKey: 'AUTO_REPAIR_MIN_SCORE',
    defaultValue: '70',
  },
  {
    key: 'AUTO_REPAIR_MAX_ATTEMPTS',
    label: 'Auto Repair Max Attempts',
    description: '每个项目允许自动补全重试的最大次数，避免反复消耗 token。',
    category: 'queue',
    input: 'number',
    envKey: 'AUTO_REPAIR_MAX_ATTEMPTS',
    defaultValue: '2',
  },
  {
